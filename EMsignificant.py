...
#%%
with open('/home/rantaplan/master/projectara/STUDY.association')as file:
    remove=[]
    ...
    while counter < 1000:
        ...
        for line in file:
            ...
            if splittedline[0] ==snpA or splittedline[0]==snpB:
                ...
                if len(snps)==2:
                    break
                    #ta vazw arxika se lista gia na kanw tin anazitisi me mia mono if(ara me ena mono skanarisma tou arxeiou)
